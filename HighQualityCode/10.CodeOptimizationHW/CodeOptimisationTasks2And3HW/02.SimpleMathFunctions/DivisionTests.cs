...
namespace _02.SimpleMathFunctions
{
    public static class DivisionTests
    {
        ...
        {
            Console.Write("Test Multiply for int:\t");
        ...
        {
            Console.Write("Test Multiply for long:\t");
            DisplayTime.DisplayExecutionTime(() =>
            {
                long i = start;
                for (; i < end; i += step)
        ...
        {
            Console.Write("Test Multiply for float:\t");
            DisplayTime.DisplayExecutionTime(() =>
            {
                float i = start;
                for (; i < end; i += step)
        ...
        {
            Console.Write("Test Multiply for double:\t");
            DisplayTime.DisplayExecutionTime(() =>
            {
                double i = start;
                for (; i < end; i += step)
        ...
        {
            Console.Write("Test Multiply for decimal:\t");
            DisplayTime.DisplayExecutionTime(() =>
            {
                decimal i = start;
                for (; i < end; i += step)
