...
namespace _02.SimpleMathFunctions
{
    public static class SubstractionTests
    {
        ...
        {
            Console.Write("Test Substraction for int:\t");
        ...
        {
            Console.Write("Test Substraction for long:\t");
            DisplayTime.DisplayExecutionTime(() =>
            {
                long i = start;
                for (; i < end; i += step)
        ...
        {
            Console.Write("Test Substraction for float:\t");
            DisplayTime.DisplayExecutionTime(() =>
            {
                float i = start;
                for (; i < end; i += step)
        ...
        {
            Console.Write("Test Substraction for double:\t");
            DisplayTime.DisplayExecutionTime(() =>
            {
                double i = start;
                for (; i < end; i += step)
        ...
        {
            Console.Write("Test Substraction for decimal:\t");
            DisplayTime.DisplayExecutionTime(() =>
            {
                decimal i = start;
                for (; i < end; i += step)
